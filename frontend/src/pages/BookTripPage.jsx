...
import FlightSearch from "../components/booking/FlightSearch"; // Your component is imported here
    ...
    return (
        <div className="space-y-8 animate-fade-in-up">
            <div className="p-6 bg-gray-900/50 border border-gray-800 rounded-xl">
                {/* Tab buttons for switching between search types */}
                ...
                {/* This is the main content area where the correct component is rendered based on the active tab. */}
                <div>
