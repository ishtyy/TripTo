        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-end">
            <div>
             ...
             <div>
                ...
                <input type="month" className="w-full px-4 py-3 rounded-lg bg-gray-800 text-white border-2 border-gray-700 focus:outline-none focus:border-cyan-500 transition-colors" />
            </div>
        </div>
